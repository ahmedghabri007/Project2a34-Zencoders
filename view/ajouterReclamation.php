...
<head>
    <meta charset="utf-8">
    <title>Startup - Réclamation</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Réclamation</h1>
                    <a href="" class="h5 text-white">Home</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Réclamation</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-primary text-uppercase">Réclamation</h5>
                <h1 class="mb-0">Soumettez votre réclamation</h1>
            </div>
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow slideInUp" data-wow-delay="0.6s">
                    <div class="bg-light p-5 h-100">
                        <h3 class="mb-4">Informations importantes</h3>
                        ...
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="ps-4">
                                ...
                                <p class="mb-0">Nous nous engageons à traiter votre réclamation sous 48h ouvrées</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center mb-4">
                            <div class="bg-primary d-flex align-items-center justify-content-center rounded" style="width: 60px; height: 60px;">
                            ...
                            <div class="ps-4">
                                ...
                                <p class="mb-0">Vous recevrez un accusé de réception par email</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ps-4">
                                ...
                                <p class="mb-0">Appelez-nous au +216 97 118 435</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                ...
                                <p class="mb-0">Mohamedsalim.Hmili@esprit.tn</p>
                            </div>
                            <div class="d-flex mb-2">
