<?php
// Démarrer la session dès le début du fichier PHP
session_start();
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                if (isset($_SESSION['fullname'])) {
                    ...
                    echo '<span class="text-white ms-3">👋 ' . htmlspecialchars($_SESSION['fullname']) . '</span>';
                    echo '<a  href="../../controller/controllerclient.php?action=logout" class="btn btn-danger py-2 px-4 ms-3">Logout</a>';

                } else {
                    // Sinon afficher le bouton de login
                    echo '<button type="button" class="btn btn-primary py-2 px-4 ms-3" data-bs-toggle="modal" data-bs-target="#authModal">Login</button>';
                }
                ?>
            </div>
        </nav>
                ...
                <div class="modal-body">
                    ...
                    <div class="tab-content py-4">
                        ...
                        <div class="tab-pane fade show active" id="login" role="tabpanel">
                            <form id="loginForm" action="../../controller/controllerclient.php?action=login" method="POST">
                                <div class="mb-3">
                                ...
                                <div class="mb-3 position-relative">
                                    ...
                                    <button type="button" class="btn btn-sm position-absolute end-0 top-0 pt-3 pe-3 toggle-password">
                                        <i class="bi bi-eye"></i>
                                    </button>
                                </div>
                                ...
                                <p class="text-center mt-3">
                                    New to Startup? <a href="#" class="text-primary" onclick="switchToSignup()">Create Account</a>
                                </p>
                            </form>

                            <!-- Signup Form -->
                            <div class="tab-pane fade" id="signup" role="tabpanel">
                                <form id="signupForm" action="../../controller/controllerclient.php?action=inscription" method="POST">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="tel" class="form-control" id="signupPhone" name="signupPhone" required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="signupAge" class="form-label">Age</label>
                                            <input type="number" class="form-control" id="signupAge" name="signupAge" min="18" max="100" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            <label for="signupGender" class="form-label">Gender</label>
                                            <select class="form-select" id="signupGender" name="signupGender" required>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label for="signupLifeStatus" class="form-label">Life Status</label>
                                            <select class="form-select" id="signupLifeStatus" name="signupLifeStatus" required>
                                                <option value="">Select</option>
                                    ...
                                    <p class="text-center mt-3">
                                        Already have an account? <a href="#" class="text-primary" onclick="switchToLogin()">Sign In</a>
                                    </p>
                                </form>
                            </div>
                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('signupForm')?.addEventListener('submit', function(e) {
                ...
                const formData = {
                    ...
                    lifeStatus: document.getElementById('signupLifeStatus').value,
